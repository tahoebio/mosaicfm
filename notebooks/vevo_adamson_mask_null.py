...
for select_gene in select_gene_list:
    ...
    print(select_gene_, select_gene, rank_celltype_0) 
    np.savez('/scratch/hdd001/home/haotian/perturb_data/vevo_adamson_mean_gene_emb/mean_gene_emb_{}_null_{}_{}.npz'.format(select_gene_, select_gene, rank_celltype_0), **dict_sum_condition_mean)
