...
def main(model_name, wandb_id, save_dir):
    ...
    save_dir = os.path.join(save_dir, model_name) # Change this to the path where you want to save the model
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Prepare the specified model for inference.")
    parser.add_argument("--model_name", required=True, help="Name of the model") #scgpt-70m-1024-fix-norm-apr24-data
    parser.add_argument("--wandb_id", required=True, help="id of the desired run in wandb") #55n5wvdm
    parser.add_argument("--save_dir", required=True, help="path to where to save") #f"/vevo/scgpt/checkpoints/release/
