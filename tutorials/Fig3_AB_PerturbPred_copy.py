# WANDB run
# Norman
# https://wandb.ai/scformer-team/scGPT-public/runs/3a6dz39i?workspace=user-
# Adamson
# https://wandb.ai/scformer-team/scGPT-public/runs/rqdrlfgn?workspace=user-
# Replogle
# https://wandb.ai/scformer-team/scGPT-public/runs/1f5an0u6?workspace=user-
...
from scgpt.utils import map_raw_id_to_vocab_id, set_seed, compute_perturbation_metrics
...
with open(save_dir / "git_diff.diff", "w") as f:
    f.write(scg.utils.get_git_diff())
